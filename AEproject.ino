...
void showUnlockMessage() {
  lcd.clear();
  lcd.setCursor(0, 0);
  // lcd.write(ICON_UNLOCKED_CHAR); // Commented out
  lcd.setCursor(4, 0);
  lcd.print("Unlocked!");
  lcd.setCursor(15, 0);
  // lcd.write(ICON_UNLOCKED_CHAR); // Commented out
...
void safeUnlockedLogic() {
  ...
  if (readyToLock) {
    ...
    // lcd.write(ICON_UNLOCKED_CHAR); // Commented out
    lcd.print(" ");
    // lcd.write(ICON_RIGHT_ARROW); // Commented out
    lcd.print(" ");
    // lcd.write(ICON_LOCKED_CHAR); // Commented out
